...
from src.third_party.videosaur.videosaur.data import transforms_video
...
def build(config):
    ...
    use_segmentations = config.get("use_segmentations", True)
    ...
    segmentation_transformation = None
    if split == "val" and use_segmentations:
