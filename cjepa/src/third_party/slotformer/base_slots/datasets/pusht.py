...
class PushTSlotsDataset(PushTDataset):
...
def build_pusht_dataset(params, val_only=False):
    ...
    val_dataset = PushTDataset(**args)
    if val_only:
        return val_dataset
    args['split'] = 'train'
    train_dataset = PushTDataset(**args)
    return train_dataset, val_dataset


def build_pusht_slots_dataset(params, val_only=False):
    ...
    val_dataset = PushTSlotsDataset(**args)
    if val_only:
        return val_dataset
    args['split'] = 'train'
    args['video_slots'] = slots['train']
    train_dataset = PushTSlotsDataset(**args)
    return train_dataset, val_dataset
