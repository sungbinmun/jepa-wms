...
OmegaConf.register_new_resolver(
    "num_patches",
    lambda up, up_size, input_size, patch: int(up_size) * int(up_size)
    if bool(up)
    else (int(input_size) // int(patch)) * (int(input_size) // int(patch)),
)
...
VIT_PARAMS = {
    ...
    "vit_base_patch16_dinov3": {"FEAT_DIM": 768, "NUM_PATCHES": 196},
}
